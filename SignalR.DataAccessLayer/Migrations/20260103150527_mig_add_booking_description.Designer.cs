...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20260103150527_mig_add_booking_description")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.CustomerSeat", b =>
                {
                    b.Property<int>("CustomerSeatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CustomerSeatId"), 1L, 1);

                    b.Property<string>("CustomerSeatName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("CustomerSeatId");

                    b.ToTable("CustomerSeats");
                });
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Basket", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.CustomerSeat", "CustomerSeat")
                        .WithMany("Baskets")
                        .HasForeignKey("CustomerSeatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
